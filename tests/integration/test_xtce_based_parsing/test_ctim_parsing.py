...
def test_ctim_parsing(ctim_test_data_dir):
    ...
    pkt_def = definitions.XtcePacketDefinition(test_xtce, root_container_name="CCSDSTelemetryPacket")
    print("Done")

    print("Loading and parsing data")
    test_packet_file = ctim_test_data_dir / 'ccsds_2021_155_14_39_51'
    with open(test_packet_file, 'rb') as pkt_file:
        pkt_gen = packet_generator(pkt_file, definition=pkt_def, show_progress=True)
